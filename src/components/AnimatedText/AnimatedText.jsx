      ...
      {({ isHoveringText }) => (
        <div
          ...
          <motion.h1
            ...
            initial="initial"
            animate="animate"
            className={`inline-block w-full font-bold capitalize text-8xl ${isHoveringText ? "text-dark bg-light dark:bg-inherit dark:text-light" : "text-dark dark:bg-inherit dark:text-light"
              } ${className}`}
          >
